...
# Option prompt
action=$(zenity --list --title="Install or Uninstall ZeroTier GUI" --text="Choose an action:" --radiolist --column "Select" --column "Action" TRUE "Install" FALSE "Uninstall" FALSE "Cancel" --height=400 --width=400)
